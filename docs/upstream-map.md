...
- The independent FP8 row-wise `_scaled_mm` safety fix at `58f4b9ec0e166205c4dfd0c6ec184ea83b5957e6` is imported as the first conflict-free issue #77 slice. It protects native-FP8 deployments and leaves Pascal on the existing W8A16 path; it is not P4 performance evidence.
