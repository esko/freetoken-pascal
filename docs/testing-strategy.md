...
The Qwen model attachment tests use fake layers and a borrowed bundle to prove complete
prevalidation, all-layer adapter construction, middle-layer rollback, duplicate and
