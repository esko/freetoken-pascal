...
class ModelConfig:
    ...
    # Explicit H0-only model fixture mode. It permits non-production tensor geometry on
    # CPU reference implementations while all CUDA fused dispatch remains fail-closed.
