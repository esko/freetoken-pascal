...
def iter_weights_parallel(
    ...
    *,
    ...
    """Compatibility hook; dense Qwen loading shares the deterministic fusion reader.

    Expert banks use the dedicated NVFP4 source loader above, so this hook never fabricates a
    second expert representation or silently routes heterogeneous GGUF tensors through it.
    """
    del workers, chunk
