...
// overflows it and cudaLaunchKernel fails with cudaErrorInvalidConfiguration.
// Keep chunks token-aligned so the kernel's blockIdx.z / top_k arithmetic remains valid.
