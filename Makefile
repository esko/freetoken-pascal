...
python-check:
	...
	ruff check python/freetoken/engine/placement_plan.py tests/engine/test_placement_plan.py
	ruff format --check python/freetoken/engine/placement_plan.py tests/engine/test_placement_plan.py
